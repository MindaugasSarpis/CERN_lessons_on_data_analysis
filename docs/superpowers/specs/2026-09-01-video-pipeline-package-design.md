...
Course-specific clips (stay in this course, release `videos-web`, same renaming rule): `vu_physics_faculty.mp4` (maintainer-supplied, the L01 reel opener; profile `standard`), `gtc_2020.mp4`, `technology_size_comparison.mp4`, `cpu_vs_gpu_demo.mp4`, `how_computer_memory_works.mp4` (`standard-tight`; will still exceed `max_size_mb` — accepted, warning only). Dropped: `VU_VM.mp4` and the misspelt duplicate `Perseverence_…` release asset (after pass 2; pass 1 still references it, §8.1.1). `VU_VM_Zoom.mp4` (Google Earth pull-back from the Physics Faculty to the cosmos, 2:31, HEVC) was listed here as an orphan but became the L01 cold open on 2026-09-06 — it joins the course-specific clips as `vu_vm_zoom.mp4` (profile `standard`) in pass 2.
