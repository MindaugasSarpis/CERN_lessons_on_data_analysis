"""Balanced axis labels — readable and proportional (Wilke fig 24.3 — good)."""
...
def render() -> None:
    ...
    _build(ax, df, font_sz=12, marker_sz=46)
    fig.tight_layout()
    save(fig, "small_axis_labels", "aus_athletes_balanced")
