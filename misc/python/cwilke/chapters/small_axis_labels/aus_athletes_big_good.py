"""Large labels with proportionally larger points — balanced (Wilke fig 24.5 — good)."""
...
def render() -> None:
    ...
    _build(ax, df, font_sz=18, marker_sz=110)
    fig.tight_layout()
    save(fig, "small_axis_labels", "aus_athletes_big_good")
