"""Tech stocks with x-axis title omitted (years are self-evident, Wilke fig 30.4)."""
...
def render() -> None:
    ...
    fig.tight_layout()
    save(fig, "figure_titles_captions", "tech_stocks_minimal_labeling")
